...
spark = SparkSession.builder \
    ...
    .config("spark.sql.suffle.partitions", "50")\
    .getOrCreate()
...
# 2. Padronização de uma vez só partindo do df original
...
# Trata Valores nulos de uma coluna da tabela expecifica.

# -- df_tratado = df_tratado.dropna(subset=["valor_parcela"])-- 

# Trata valores nulos da tabela inteira
